...
Verified with `Suchbegriffe=Mustererkennung`: returned 2 hits — *Mustererkennung* (Prof. Person D) and *Praktikum Mustererkennung* (Dr. Person B).
  ...
  "courses": [
    {
      ...
      "instructorsResp": ["Person D"],
      "instructorsExec": ["Person B"],
