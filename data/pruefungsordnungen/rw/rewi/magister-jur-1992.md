...
scraped_at: 2026-04-25T16:06:09+00:00
page_count_chars: 8895
---
...
Aufgrund von Art. 6 und Art. 81 des Bayerischen Hochschulgesetzes (BayHSchG) und aufgrund des § 47 der Qualifikationsverordnung erlaBt die Friedrich-Alexander-Universitat ErlangenNirnberg folgende Satzung: 
...
- (1) Die Juristische Fakultat verleiht fir die Friedrich-Alexander-Universitat ErlangenNiirnberg auslandischen Studenten, die auBerhalb des Geltungsbereichs des Grundgesetzes ein Rechtsstudium erfolgreich abgeschlossen haben, den akademischen Grad eines Magister Legum (LL.M.). 
...
- (1) . Die Qualifikation fiir das Magisterstudium fiir auslandische Juristen wird nachgewiesen 

- e durch den erfolgreichen Abschlu8 eines dem deutschen Rechtsstudium vergleichbaren und gleichwertigen juristischen Studiums an einer Hochschule auBerhalb des Geltungsbereichs des Grundgesetzes. 
...
Der Student wird von einem Hochschullehrer der Fakultét betreut, den der Dekan im Einverstindnis mit den Beteiligten als Betreuer bestellt. Ein Wechsel in der Person des Betreuers auf Wunsch des Studenten ist méglich. 
...
- . Student wahlt die Lehrveranstaltungen im Einverstandnis mit dem Betrever aus. 
...
- (4) Der Antragsteller hat schriftlich zu erklaren, daB 
   ...
   2. die eingereichte Magisterarbeit nicht anderweitig als Prifungsleistung verwendet worden ist; 
...
- (1) Die Zulassung zur miindlichen Magisterpriifung setzt voraus 
   ...
   2. den Nachweis der Immatrikulation im Magisterstudium fiir auslindische Juristen; 3. . den Nachweis eines ordnungsgemaBen Magisterstudiums gemaB § 4. 
...
- (5) Die Priifung erfolgt in deutscher Sprache und dauert je Prifungskandidat und Rechtsgebiet etwa 15 Minuten. Sie wird von dem jeweiligen Priifer in Gegenwart eines sachkundigen Beisitzers abgenommen. Von den miindlichen Priifungen sollen Niederschriften angefertigt werden, aus denen die wesentlichen Gegenstinde und das Ergebnis der Priifung hervorgehen. 
...
, Akteneinsicht, Wiederholungsprifung, Tauschung 
...
- . Ausgefertigt aufgrund der Beschitisse des Senats der Universitat Erlangen-Ntrnberg vom 26. Februar und 27. Mai 1992 und der Genehmigung des Bayerischen Staatsministeriums fir Unterricht, Kultus, Wissenschaft und Kunst mit Schreiben vom 3. August 1992 Nr. X/5-6/87 251. 
