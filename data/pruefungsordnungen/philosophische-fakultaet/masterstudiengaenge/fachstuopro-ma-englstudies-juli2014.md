...
scraped_at: 2026-04-25T15:24:20+00:00
page_count_chars: 20293
---

# PDF 28 of July 2014

**PDF source:** <https://zuv.fau.de/universitaet/organisation/recht/studiensatzungen/PHIL1/pdf-englisch/FachStuOPrO-MA-EnglStudies.JULI2014.pdf>
...
The degree programme and examination regulations for the research-orientated consecutive Master's degree programme English Studies with the title 'Master of Arts (MA)' complement the General Examination Regulations for the Bachelor's and Master's Degree Programmes at the Faculty of Humanities, Social Sciences, and Theology of Friedrich-Alexander-Universität Erlangen-Nürnberg – ABMStPO/Phil. 
...
shall submit a letter of motivation in English of no more than two pages with their application. 
...
- Recommended from the second semester. 

- ** Can be completed from the first semester. 

*** The first tutorial from the MA module _Advanced Language_ , _Discourse Structure_ , should be attended in the first semester but the examination only takes place in the second semester after completion of the course _Academic Discourse_ . 

- **** The specialisation modules in the branch of study _Culture and Literature_ can be chosen in _Culture_ and _Literature_ or in _Culture_ or _Literature_ . Students can choose freely which Master's module they want to attend in which subject. 
...
2. Modules worth approx. 30 ECTS credits each must be chosen from the modules offered for the first three semesters. 

3. Over the course of the degree programme, at least three modules must be chosen in which students are required to complete a written assignment. 

4. A maximum total of 30 ECTS credits can be achieved in the specialisation ENGLISH STUDIES: LINGUISTICS AND APPLIED LINGUISTICS with the following distribution: 

- up to 20 ECTS credits from modules from the specialisation **ENGLISH STUDIES: CULTURE AND LITERATURE** 

- up to 20 ECTS credits (German language) from 

   - the module Angewandte und deskriptive Linguistik der romanischen Sprachen from the **MASTER'S DEGREE PROGRAMME LINGUISTICS** and/or 

   - basic module B2 Lexikografie **Germanistik EMLex (European Master of Lexicography)** and/or an MA module from German as a Foreign Language, if available. 
...
- up to 20 ECTS credits from optional language modules O-1 or O-2 in all languages except English that are not the native language of the student (with the exception of translation courses); e.g., depending on the courses offered by the Language Centre, Chinese, French, Italian, Dutch, Norwegian and Spanish (insofar as the admission requirements of the Language Centre have been fulfilled). 
   ...
   - The module O-1 may be chosen up to two times (either for two different languages or for different levels of the same language). The module O-2 can either be chosen individually or in combination with the module O-1. 

- up to 10 ECTS credits from the basic module and the advanced module A **Computer science as a minor subject** (German language) 

5. Students whose native language is English shall replace all English language courses in the modules of the degree programme (Module 2 as well as the language workshops 5A and 5B) with other modules, especially language courses in other languages, such as German as a foreign language. 
