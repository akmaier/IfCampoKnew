...
scraped_at: 2026-04-25T14:22:53+00:00
page_count_chars: 9117
---

# 28. März 2011

**PDF source:** <https://zuv.fau.de/universitaet/organisation/recht/studiensatzungen/Lehramt/Aenderungssatzungen/3AES%20LA-Deutsch.pdf>
...
b) In der Tabelle von Nr. 1 Buchst. d wird in Zeile 4 und 5 (Examenskurse) Spalte 5 jeweils die Abkürzung "SL" eingefügt. 

c) In der Tabelle von Nr. 2 Buchst. a Teilgebiet A erhält die Spalte 5 

(Prüfungsleistung) folgende Überschrift "Studien- und Prüfungsleistung". 

d) In der Tabelle von Nr. 2 Buchst. a Teilgebiet A Zeile 3 (Modul Gram) und Zeile 8 (Modul Lex) Spalte 5 werden jeweils ein Komma und die Worte "SL zur VL" angefügt. 

e) In der Tabelle von Nr. 2 Buchst. a Teilgebiet A werden folgende Module angefügt: " 
...
g) In der Tabelle von Nr. 2 Buchst. a Teilgebiet B Zeile 3 (Modul Med 2) Spalte 5 wird ein Komma und die Worte "SL zur VL" angefügt. 

h) In der Tabelle von Nr. 2 Buchst. a Teilgebiet B wird folgendes Modul angefügt: 
...
||deutscher Literatur|||**HS, SL zur Übung**|
|---|---|---|---|---|
...
"Vertiefungsmodule" ersetzt, nach dem Wort "Lex" das Wort "DaF" angefügt, nach dem Wort "Med 2" das Wort "Intermed" angefügt sowie nach dem Wort "Komp" ein Komma und das Wort "Kult" angefügt. 

- n) In den nachfolgenden Erläuterungen wird jeweils das Wort "Modul'" durch das Wort 

- "Spezialisierungsmodul" ersetzt sowie die Buchstab. A bis C wie folgt ersetzt: 
...
bb) In Nr. 2 Buchst. a Ziff. A erhält Spalte 5 (Prüfungsleistung) folgende Überschrift "Studienund Prüfungsleistung" sowie in Zeile 3 (Modul Gram) und 7 (Modul Mex) Spalte 5 wird nach dem Wort "HS" jeweils ein Komma und die Worte "SL zur VL" angefügt. 
...
bb) In Nr. 2 Buchst. a Ziff. A erhält Spalte 5 (Prüfungsleistung) folgende Überschrift "Studienund Prüfungsleistung" sowie in den Zeilen 3 (Modul Gram) und 7 (Modul Lex) Spalte 5 wird nach dem Wort "HS" jeweils ein Komma und die Worte "SL zur VL" angefügt. 

cc) In Nr. 2 Buchst. a Ziff. C erhält Spalte 5 (Prüfungsleistung) folgende Überschrift "Studienund Prüfungsleistung" sowie in den Zeilen 3 (Modul NdL 2) und 7 (Modul Komp) Spalte 5 wird nach dem Wort "HS" jeweils ein Komma und die Worte "SL zur VL" angefügt. 
...
Die Satzung wurde am 28. März 2011 in der Universität Erlangen-Nürnberg niedergelegt; die Niederlegung wurde am 28. März 2011 durch Anschlag in der Universität Erlangen-Nürnberg bekannt gegeben. Tag der Bekanntmachung ist der 28. März 2011. 
