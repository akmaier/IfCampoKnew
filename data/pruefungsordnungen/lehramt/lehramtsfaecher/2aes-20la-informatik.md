...
1. § 5 wird wie folgt geändert: 
   ...
   - a) Abs. 1 wird wie folgt geändert: 
      ...
      - dd) In den Zeilen 7 und 8 Spalte 6 (Studien- und Prüfungsleistung) wird jeweils nach dem Buchstaben "S" der Buchstabe "L" eingefügt. 

      - ee) In Zeile 9 (Praktikum) Spalte 6 (Studien- und Prüfungsleistung) werden die Buchstaben "bS" durch "PL lt. MB" ersetzt. 

      - ff) In den Zeilen 10 und 11 Spalte 6 (Studien- und Prüfungsleistung) wird jeweils nach dem Buchstaben "S" der Buchstabe "L" eingefügt. 

      - gg) In Zeile 12 (Wahlpflichtmodul(e)) Spalte 6 (Studien- und Prüfungsleistung) wird "PL lt. MB" eingefügt. 

      - hh) In Zeile 15 (Modul Math. Modellbildung…) Spalte 6 (Prüfung) wird vor dem Buchstaben "K" der Buchstabe und das Zeichen "SL+" angefügt. 

      - ii) In den Zeilen 16 und 18 (sonst: Wahlpflichtmodul(e)) Spalte 6 (Studien- und Prüfungsleistung) wird jeweils "PL lt. MB" eingefügt. 

      - jj) In Zeile 17 (Begleitseminar) Spalte 6 (Studien- und Prüfungsleistung) werden die Buchstaben "bS" durch die Buchstaben "SV" ersetzt. 

kk) In den Erläuterungen werden die Worte "S: (unbenoteter) Schein" durch die Worte "SL: (unbenotete) Studienleistung" ersetzt, die Worte "bS: benoteter Schein durch "PL: (benotete) Prüfungsleistung" ersetzt sowie folgendes angefügt: "SV: Seminarvortrag mit Diskussion, MB: Modulbeschreibung". 

- b) Abs. 2 wird wie folgt geändert: 

   - aa) In Zeile 1 der Tabelle Spalte 6 werden die Buchstaben "bS" durch die Buchstaben "HMA" ersetzt. 

   - bb)  Folgende Erläuterungen werden angefügt: 
...
c) Abs. 3 wird wie folgt geändert: 
   ...
   - cc)  Folgende Erläuterungen werden angefügt: 
...
- a) Abs. 1 wird wie folgt geändert: 
   ...
   - ff) In Zeile 12 (Math. Modellbildung) Spalte 6 (Studien- und Prüfungsleistung) wird vor dem Buchstaben "K" die Buchstaben und das Zeichen "SL+" eingefügt. 

   - gg) In Zeile 13 (sonst: Wahlpflichtmodule(e)) Spalte 6 (Studienund Prüfungsleistung) werden die Buchstaben "PL lt. MB" eingefügt. 

   - hh) In Zeile 15 (Begleitseminar zur schriftlichen Hausarbeit) Spalte 6 (Studienund Prüfungsleistung) werden die Buchstaben "bS" durch die Buchstaben "SV" ersetzt. 
