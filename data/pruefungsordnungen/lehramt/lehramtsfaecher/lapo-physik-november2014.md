...
scraped_at: 2026-04-25T14:29:00+00:00
page_count_chars: 16120
---

# pdf vom 30.03.2009 i.d.F. 13.11.2014

**PDF source:** <https://zuv.fau.de/universitaet/organisation/recht/studiensatzungen/Lehramt/word/LAPO-Physik-NOVEMBER2014.pdf>
...
|---|---|---|---|---|
|5|EinführungFachdidaktik Physik(DDP-1)|2V+2Ü|5|Mündlich,30 Min.|
|8|Hauptseminar (DDP-2):<br>Experimente im Physikunterricht|2S+2Ü|5|Portfolioprüfung:<br>3 Seminarvorträge<br>(30 Min.) mit Ausarbeitung<br>(ca. 6 bis 9 S.)|
||**Summe Fachdidaktik:**||**10**||



(4) Im Rahmen der Vorgaben der LPO I § 22 Abs. 2 Nr. 3f (freier Bereich) können weitere fachwissenschaftliche und fachdidaktische Module aus dem gesamten Lehrangebot des Departments für Physik eingebracht werden. 
...
4. mindestens 20 ECTS-Punkte aus den Modulen _Theoretische Physik 1-4 LA (TPL-1 bis TPL-4);_ alternativ können auch Module aus dem Theorie-Zyklus des Bachelorstudiums Physik _(TP-1 bis TP-4)_ eingebracht werden. 

(2) Wird die Zulassungsarbeit in Physik angefertigt, so kann das Bachelorkolloquium mit 5 ECTS-Punkten gemäß § 22 Abs. 2 Nr. 3f LPO I in den freien Bereich eingebracht werden. 
...
|**Fach-**<br>**semester**|**Modul**|**SWS**|**ECTS**|**Prüfungs- und Studienle-**<br>**istung**|
|---|---|---|---|---|
|1|Experimentalphysik 1 LANV (EPNV-1):<br>Mechanik und Wärme|4V+2Ü|7,5|Klausur, 90 Min.|
|2|Experimentalphysik 2 LANV (EPNV-2):<br>Elektrodynamik,Wellen und Optik|4V+2Ü|7,5|Klausur, 90 Min.|
|3|Quantenphysik LANV(QPNV)|2V+1Ü|5|Klausur,90 Min.|
|3|Grundpraktikum 1 LANV(GPNV-1)|5P|7,5|Praktikumsbescheinigung|
...
|**Fach-**<br>**semester**|**Modul**|**SWS**|**ECTS**|**Prüfungs- und**<br>**Studienleistung**|
|---|---|---|---|---|
|4|Einführungsvorlesung Physik (DDPNV-1),<br>alternativ ist DDP-1 mit 5 ECTS-Punkten<br>möglich|2V|3|Mündlich, 30 Min.|
|5|Hauptseminar (DDP-2):<br>Experimente im Physikunterricht|2S+2Ü|5|Portfolioprüfung:<br>3 Seminarvorträge<br>(30 Min.) mit Ausarbeitung<br>(ca.6 bis 9 S.)|
...
|---|---|---|---|---|
|1|Experimentalphysik 1 LANV (EPNV-1):<br>Mechanik und Wärme|4V+2Ü|7,5|Klausur, 90 Min.|
|3|Grundpraktikum 1 LANVDG(GPNVDG-1)|3P|4,5|Praktikumsbescheinigung|
|4|Einführung Fachdidaktik Physik (DDPNV-1),<br>alternativ istDDP-1 mit 5ECTS-Punkten möglich|2V|3|Mündlich, 30 Min.|
|5|Hauptseminar* LANV (DDP-2):<br>Experimente im Physikunterricht|2S+2Ü|5|Portfolioprüfung:<br>3 Seminarvorträge (30<br>Min.) mit Ausarbeitung (ca.<br>6 bis 9 S.)|
...
4Auf schriftlichen Antrag an die Vorsitzende oder den Vorsitzenden des Prüfungsausschusses kann für Studierende, die ihr Studium vor dem Wintersemester 2010/2011 im Lehramt für Gymnasien aufgenommen haben, hinsichtlich der Berechnung der Bachelornote § 7 Abs. 3 dieser Änderungssatzung, angewendet werden. 
