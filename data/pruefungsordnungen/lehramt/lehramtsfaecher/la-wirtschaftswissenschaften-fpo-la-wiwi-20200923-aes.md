...
1. § 2 wird wie folgt geändert: 
   ...
   - a) Nach den Worten „Lehramt an Realschulen“ wird das Wort „Module“ durch die Worte „ein Modul“ ersetzt. 

   - b) Nach den neuen Worten „ein Modul im Umfang von“ wird die Zahl „15“ durch die Zahl „5“ ersetzt. 
...
bb)  Die neue Zeile 7 (Mikroökonomie) wird wie folgt geändert: 

- (1) In Spalte 9 (2.) wird die Zahl „5“ gestrichen. 

- (2) In Spalte 10 (3.) wird die Zahl „5“ eingefügt. 

cc) Die alte Zeile 7 (Makroökonomie) wird gestrichen. 

dd)  Zeile 17 (Summe SWS) wird wie folgt geändert: 

   - (1) In Spalte 2 wird die Zahl „26“ durch die Zahl „24“ ersetzt. 

   - (2) In Spalte 3 wird die Zahl „9“ durch die Zahl „10“ ersetzt. 

- b) Die zweite Tabelle (2. Fachwissenschaft 7.-9. Semester) wird wie folgt geändert: 

aa)  Zeile 6 (Konzeptionelle Modellierung) Spalte 5 (Workload-Verteilung pro Semester in ECTS-Punkten) wird wie folgt geändert: 
...
- b) Zeile 15 (Summe:) wird wie folgt geändert: 

aa) In Spalte 2 wird die Zahl „22“ durch die Zahl „20“ ersetzt. 
