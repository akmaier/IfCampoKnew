...
title: "PDF vom 25.09.2007 i.d.F. 06.05.2010"
pdf_source: https://zuv.fau.de/universitaet/organisation/recht/studiensatzungen/TECHFAK/FPO-BA-MA_Mechatron.pdf
...
scraped_at: 2026-07-01T11:33:19+00:00
page_count_chars: 15733
---

# PDF vom 25.09.2007 i.d.F. 06.05.2010

**PDF source:** <https://zuv.fau.de/universitaet/organisation/recht/studiensatzungen/TECHFAK/FPO-BA-MA_Mechatron.pdf>
...
Die Fachprüfungsordnung für den Bachelor- und den konsekutiven Masterstudiengang Mechatronik ergänzt die Allgemeine Prüfungsordnung für die Bachelor- und Masterstudiengänge an der Technischen Fakultät der Friedrich-Alexander-Universität Erlangen-Nürnberg (§§ 1 bis 33). 
...
(2) Der Bachelorstudiengang Mechatronik umfasst die in der **Anlage 1** aufgeführten Module B 1 bis B 30 einschließlich sechs Wochen für die Ableistung des Teiles der insgesamt zwölf Wochen umfassenden berufspraktischen Tätigkeit, der während des Studiums zu erbringen ist, und die Zeit für die Anfertigung einer Bachelorarbeit. 
...
(4) Weiterhin sind 12,5 ECTS-Punkte technische Wahlmodule sowie 12,5 ECTSPunkte nichttechnische Wahlmodule aus dem Angebot der gesamten Universität zu erwerben. 
...
(6) Module, die bei einem konsekutiven Studium nach dieser Prüfungsordnung bereits im Bachelorstudium Mechatronik gewählt wurden, können im Masterstudium nicht mehr gewählt werden. 

## **§ 44 Prüfungen des Masterstudiums** 

(1) Spätestens bei der Zulassung zur ersten Prüfung der Masterprüfung muss die Wahl der Vertiefungsrichtungen nach § 43 Abs. 2 feststehen. 
...
## **§ 47 Bewertung der Leistungen des Masterstudiums** 
...
(2)<sup>1</sup> Bei der Bildung der Gesamtnote gehen alle Module nach **Anlage 2** einschließlich der Masterarbeit mit dem Gewicht der zugeordneten ECTS-Punkte ein.<sup>2</sup> Für den Fall, dass die Summe der einer Vertiefungsrichtung zugeordneten Module 15 ECTSPunkte überschreitet, wird eine Zwischennote entsprechend der ECTS-Gewichtung der Einzelmodule gebildet und diese mit einem Gewicht von 15 ECTS-Punkten auf die Gesamtnote angerechnet.<sup>3</sup> Gleiches gilt für den Bereich der technischen und nichttechnischen Wahlmodule. 
...
Studienplan des Bachelorstudiums Mechatronik an der Friedrich-Alexander-Universität ErlangenNürnberg 

|Modul-|<br>Modulbezeichnung|GOP/|Um|fang|Verte|ilung|der E|CTS-|Punkt|e auf|Prü-|
|---|---|---|---|---|---|---|---|---|---|---|---|
|nr.||K|||die S|emes|ter||||<br>fung<sup>1)</sup>|
||||in S|WS||||||||
...
||Moduldaten<br>|SWS<br> <br> <br>|Verteil<br>a<br>|ung der<br>uf die S<br>|ECTS-<br>emeste<br>|Punkte<br>r<br>|Prü-<br>|
|---|---|---|---|---|---|---|---|
|Nr.|Modulbezeichnung|V<br>Ü<br>P|1.|2.|3.|4.|fung<sup>1)</sup>|
...
1) P: Prüfungsleistung (Dauer in min); bSL: benotete Studienleistung; uSL: unbenotete Studienleistung 
...
3. Elektrische Antriebstechnik und Leistungselektronik 

4. Regelungstechnik 

5. Technische Mechanik 

6. Fertigungstechnologie 
...
13. Hochfrequenztechnik und Photonik 

14. Verteilte eingebettete Systeme 

15. Simulation und Visualisierung 
