...
scraped_at: 2026-04-25T16:48:54+00:00
...
1. In der Überschrift werden nach dem Wort „Nürnberg“ die Worte „einschließlich Campus Busan“ eingefügt. 

2. § 37 Abs. 1 wird wie folgt geändert: 

   - a) Satz 1 wird wie folgt geändert: 

aa) Die  Worte „der Spalte 2, rechts,“ werden gestrichen. 

bb) In den Nummern. 1 und 2 des Satzes 1 werden jeweils die Worte „für Ingenieurberufe“ gestrichen. 

cc) In den Nummern 4 bis 6 des Satzes 1 werden  die Modulnummern „4. B13 

5. B 14 

6. B 16“ 

durch folgende Modulnummern ersetzt: „4. B14 

5. B15 

6. B17“ 

b) In Satz 2 werden die Worte „sind der Spalte 4,“ durch das Wort „sowie“ und die Worte „ist der Spalte 6“ durch das Wort „sind“ ersetzt. 

3. § 38 wird wie folgt geändert: 

a) Abs. 1 Nr. 2 wird wie folgt geändert: 

aa) In Buchst. a werden die Worte „für Ingenieurberufe“ gestrichen. 

bb) Nach Buchst. d wird folgender neuer Buchst. e eingefügt: 

„e) B8: Chemische Thermodynamik“ 

Die bisherigen Buchst. e bis w werden zu Buchst. f bis x. 

cc) Buchst. f (neu) erhält folgende Fassung: 

„f) B9: Biochemie 1 und 2“ 

dd) Die Modulnummern von Buchst. g bis l (neu) erhalten folgende Fassung: 
...
l) B18” 
   ...
   - ee) Buchst. m (neu) erhält folgende Fassung: 

   - „m) B19: Statik und Festigkeitslehre“ 

   - ff) Die Modulnummern von Buchst. n bis q (neu) erhalten folgende Fassung: 
   ...
   - gg) Buchst. r (Modul „B23: Medizinische Biotechnologie“) wird ersatzlos gestrichen. Die bisherigen Buchst. s bis x werden zu Buchst. r bis w. 

   - hh) Nach Buchst. w wird folgender neuer Buchst. x angefügt: 

   - „x) B30: Wahlpflichtmodul“ 

   - b) In Abs. 1 Nr. 3 wird die Zahl „30“ durch die Zahl „31“ ersetzt. 

   - c) In Abs. 1 Nr. 4 wird die Zahl „31“ durch die Zahl „32“ ersetzt. 

   - d) In Abs. 2 wird der Klammerzusatz „(Spalte 6)“ gestrichen. 

   - e) Folgender neuer Abs. 3 wird eingefügt: 

   - „(3) Das Wahlpflichtmodul B30 ist aus dem Katalog in der **Anlage 2** zu wählen.“ Der bisherige Abs. 3 wird zu Abs. 4. 

4. § 40 wird wie folgt geändert: 

   - a) In Abs. 2 und 3 wird jeweils nach dem Wort „Anlage“ die Zahl „1“ angefügt. 

   - b) In Abs. 2 werden die Modulnummern „B20“ und „B27“ durch die Modulnummern „B23“ und „B29“ ersetzt. 
...
- a) In Nr. 1 wird „§ 42 Abs. 1“ durch „§ 41 Abs. 1 Ziffer 1 und 2“ ersetzt. 

- b) In Nr. 2 wird „§ 42“ durch „§ 41 Abs. 1 Ziffer 3“ ersetzt. 

2 

8. § 44 wird wie folgt geändert: 

   - a) Abs. 3 wird gestrichen. Die bisherigen Abs. 4 und 5 werden zu Abs. 3 und 4. 

   - b) In Abs. 3 (neu) wird die Satzzählung redaktionell angepasst und im entsprechend korrigierten Satz 3 werden die Worte „nach Satz 1“ durch die Worte „,die ihr Studium vor dem In-Kraft-Treten dieser Prüfungsordnung aufgenommen haben,“ ersetzt. 

9. In den Anlagen 1 und 2 werden jeweils die Zeilenbezeichnungen „Spalte 1“ bis „Spalte 6“ gestrichen. 

10. Die Anlage 1 wird wie folgt geändert: 

   - a) In den Zeilen 2, 4 und 6 (Module B1 bis  B3) werden jeweils die Worte „für Ingenieurberufe“ gestrichen. 

   - b) In der Zeile 6 (Modul Mathematik D3) Spalte 5 (Ü) wird die Zahl „2“ gestrichen. 
...
„ Übung 2 *) 
   ...
   - d) In den Zeilen 8 und 9 (Modul B4) Spalte 2 werden jeweils die Abkürzungen „VT“ durch das Wort „Verfahrenstechnik“ ersetzt. 

   - e) Das Modul B7 (Physikalische Chemie) erhält folgende Fassung: 
...
„ 
   ...
   - f) Nach Modul 7 wird folgendes neue Modul B8 eingefügt: 
...
„ 
   ...
   - g) Die bisherigen Module B8 bis B31 werden zu Modulen B9 bis B32. 

   - h) In Modul B9 (neu) Spalte 2 werden die Ziffern „I“ und „II“ durch die Zahlen „1“ und „2“ ersetzt. 

   - i) In der Zeile 29 (Modul B19) Spalte 2 werden die Worte „Technische Mechanik“ durch die Worte „Statik und Festigkeitslehre“ ersetzt. 

   - j) Nach dem Modul B29 wird folgendes neue Modul B30 eingefügt: 
...
11. Folgende neue Anlage 2 wird eingefügt: 

„ **Anlage 2:** Wahlpflichtmodule des Bachelorstudiengangs Medizinische Biotechnologie Energietechnik Nachhaltige chemische Technologien – Verfahren“ 

12. Die bisherigen Anlagen 2 und 3 werden zu Anlagen 3 und 4. 

13. Anlage 3 (neu) wird wie folgt geändert: 
...
(3) Abweichend von Abs. 1 findet die Ziffer 6 und die Ziffer 11 (mit der Maßgabe, dass alle Studierenden statt dem Bachelormodul Medizinische Biotechnologie auch die neuen Wahlpflichtmodule „Energietechnik“ und „Nachhaltige chemische Technologien – Verfahren“ wählen können) auf alle Studierenden ab In-Kraft-Treten dieser Änderungssatzung Anwendung. 
...
Die Satzung wurde am 7. Juni 2011 in der Universität Erlangen-Nürnberg niedergelegt; die Niederlegung wurde am 7. Juni 2011 durch Anschlag in der Universität Erlangen-Nürnberg bekannt gegeben. Tag der Bekanntmachung ist der 7. Juni 2011. 
